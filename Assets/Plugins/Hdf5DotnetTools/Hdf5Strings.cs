...
namespace Hdf5DotNetTools {
	public static partial class Hdf5 {
		public static IEnumerable<string> ReadStrings(long groupId, string name) {
		...
		public static int WriteStrings(long groupId, string name, IEnumerable<string> strs, string datasetName = null) {
		...
		public static int WriteUnicodeString(long groupId, string name, string str, H5T.str_t strPad = H5T.str_t.SPACEPAD) {
			...
			long datasetId = H5D.create(groupId, name, dtype, spaceId);
