...
namespace Hdf5DotNetTools {
	public static partial class Hdf5 {
		...
		public static Array ReadDatasetToArray<T>(long groupId, string name) //where T : struct
		{
		...
		public static T ReadOneValue<T>(long groupId, string name) //where T : struct
		{
		...
		public static Array ReadDataset<T>(long groupId, string name) {
		...
		public static void WriteOneValue<T>(long groupId, string name, T dset) {
		...
		public static int WriteDatasetFromArray<T>(long groupId, string name, Array dset, string datasetName = null) //where T : struct
		{
			int rank = dset.Rank;
		...
		public static long AppendDataset<T>(long groupId, string name, Array dset, ulong chunkX = 200) where T : struct {
			var rank = dset.Rank;
			ulong[] dimsExtend = Enumerable.Range(0, rank).Select(i => { return (ulong)dset.GetLength(i); }).ToArray();
